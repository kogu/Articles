...
$_lang['articles.article_content'] = 'コンテンツ';
$_lang['articles.article_create'] = '記事の作成';
$_lang['articles.article_delete'] = '記事の削除';
$_lang['articles.article_delete_confirm'] = '選択した記事を削除してよろしいですか？';
$_lang['articles.article_delete_multiple'] = '複数記事の削除';
$_lang['articles.article_delete_multiple_confirm'] = '選択された複数の記事を削除してよろしいですか？';
$_lang['articles.article_edit'] = '記事の編集';
$_lang['articles.article_options'] = '記事設定';
$_lang['articles.article_publish'] = '公開';
$_lang['articles.article_selected_delete'] = '選択した記事の削除';
...
$_lang['articles.article_summary'] = '記事の概要';
$_lang['articles.article_tags'] = 'タグ';
$_lang['articles.article_title'] = '記事タイトル';
$_lang['articles.article_unpublish'] = '非公開';
$_lang['articles.articles'] = '記事';
$_lang['articles.articles_err_ns_multiple'] = '少なくとも一つの記事を選択してください。';
$_lang['articles.articles_import'] = '記事のインポート';
$_lang['articles.articles_manage'] = '記事の管理';
$_lang['articles.articles_none'] = 'まだ記事が有りません。';
$_lang['articles.articles_search'] = 'Search Articles...';
$_lang['articles.articles_view'] = '記事を見る';
$_lang['articles.articles_write_new'] = '新しい記事を書く';
$_lang['articles.author'] = '投稿者';
$_lang['articles.categories'] = 'カテゴリー';
$_lang['articles.comments'] = 'コメント';
$_lang['articles.comments.intro_msg'] = 'ここでは、記事に投稿された全てのコメントの確認と承認、または拒否が行えます。';
$_lang['articles.container'] = 'コンテナ';
$_lang['articles.container_alias'] = 'コンテナのエイリアス';
$_lang['articles.container_alias_desc'] = 'フレンドリーURLにおける、この記事コンテナのパスとなるエイリアスを指定します。';
$_lang['articles.container_create_here'] = 'ここに記事コンテナを作成';
$_lang['articles.container_delete'] = '記事コンテナを削除';
$_lang['articles.container_description'] = '概要';
$_lang['articles.container_description_desc'] = 'この記事コンテナの簡単な説明。';
$_lang['articles.container_menutitle_desc'] = '管理画面のメニューやナビゲーション要素で使用されるタイトル。';
$_lang['articles.container_new'] = '記事コンテナの新規作成';
$_lang['articles.container_publish'] = '記事コンテナの公開';
$_lang['articles.container_settings'] = '記事コンテナの設定';
$_lang['articles.container_title'] = '記事コンテナのタイトル';
$_lang['articles.container_title_desc'] = 'この記事コンテナのタイトルを指定します。';
...
$_lang['articles.content'] = 'コンテンツ';
$_lang['articles.filter_ellipsis'] = 'フィルター...';
$_lang['articles.import_blogger_container_err_nf'] = '記事をインポートする記事コンテナが見つかりませんでした。';
$_lang['articles.import_blogger_file'] = 'Blogger Export XMLファイル';
$_lang['articles.import_blogger_file_desc'] = 'BloggerからエクスポートしたXMLファイルを選択します。';
$_lang['articles.import_blogger_file_err_nf'] = 'BloggerからエクスポートしたXMLファイルを指定してください。';
$_lang['articles.import_blogger_file_server'] = 'サーバー上のBlogger Export XMLファイル';
$_lang['articles.import_blogger_file_server_desc'] = 'ファイルをアップロードする代わりに、すでにサーバー上に設置されたBlogger XMLファイルを指定することもできます。パスの指定では {core_path}, {base_path}, {assets_path} などのプレースホルダが利用可能です。';
$_lang['articles.import_modx_change_template'] = '記事コンテナのテンプレートを変更';
...
$_lang['articles.import_modx_commentsThreadNameFormat'] = 'Quipのスレッド名書式';
...
$_lang['articles.import_modx_tagsField'] = 'タグフィールド';
...
$_lang['articles.publishing_information'] = '公開設定';
$_lang['articles.settings'] = '設定';
$_lang['articles.settings_archiving'] = 'アーカイブ';
$_lang['articles.settings_comments'] = 'コメント';
$_lang['articles.settings_comments_display'] = '表示';
$_lang['articles.settings_comments_latest'] = '最新';
$_lang['articles.settings_comments_moderation'] = 'セキュリティ';
$_lang['articles.settings_comments_other'] = 'その他';
$_lang['articles.settings_general'] = '全体設定';
$_lang['articles.settings_latest_posts'] = '最近の投稿';
$_lang['articles.settings_notifications'] = '通知（外部サービス）';
$_lang['articles.settings_pagination'] = 'ページング';
$_lang['articles.settings_rss'] = 'RSS';
$_lang['articles.settings_tagging'] = 'タグ付け';
$_lang['articles.statistics'] = '統計情報';
$_lang['articles.status'] = 'ステータス';
$_lang['articles.template'] = 'テンプレート';
$_lang['articles.template_desc'] = 'メインの一覧画面で使用するテンプレート。';
$_lang['articles.tags'] = 'タグ';
...
$_lang['articles.setting.articleTemplate'] = '記事のテンプレート';
$_lang['articles.setting.articleTemplate_desc'] = '記事に使用するデフォルトのテンプレート。';
$_lang['articles.setting.tplArticleRow'] = '一覧時の記事表示用チャンク';
$_lang['articles.setting.tplArticleRow_desc'] = 'メインページやアーカイブページなどで、一覧される記事の表示に使用されるチャンク。';
$_lang['articles.setting.archiveByMonth'] = '月別アーカイブ';
$_lang['articles.setting.archiveByMonth_desc'] = 'Whether or not to archive by month or by year. Yes will archive by month.';
$_lang['articles.setting.tplArchiveMonth'] = 'アーカイブ一覧用チャンク';
...
$_lang['articles.setting.archiveGroupByYear_desc'] = '「はい」に設定されている場合、アーカイブは年でグルーピングされた月の一覧として表示されます。またその場合、月の設定は無視されます。';
...
/* Pagination */
$_lang['articles.setting.articlesPerPage'] = '1ページに表示する記事数';
$_lang['articles.setting.articlesPerPage_desc'] = '一覧時表示、1ページに表示する記事数の上限を設定します。';
$_lang['articles.setting.pageLimit'] = 'ページ数の上限';
$_lang['articles.setting.pageLimit_desc'] = 'ページング処理時、リンクが表示されるページ数の上限を設定します。';
...
/* Comments */
$_lang['articles.setting.commentsEnabled'] = 'コメント機能の使用';
$_lang['articles.setting.commentsEnabled_desc'] = '記事に対するコメントを投稿可能にします。';
$_lang['articles.setting.commentsThreaded'] = 'スレッド形式の使用';
$_lang['articles.setting.commentsThreaded_desc'] = 'スレッド形式ではコメントに対する返信コメントが可能で、レベルに応じてインデントされます。非スレッド形式の場合は、親となる記事に対してのみコメントが可能です。';
...
$_lang['articles.setting.commentsMaxDepth'] = 'スレッドの最大深度';
$_lang['articles.setting.commentsMaxDepth_desc'] = 'スレッド形式で返信可能な最大の深度を指定します。';
...
$_lang['articles.setting.commentsTplAddComment'] = '返信コメント用チャンク';
...
$_lang['articles.setting.commentsTplPreview'] = 'プレビュー用チャンク';
$_lang['articles.setting.commentsTplPreview_desc'] = 'コメントのプレビューに使用するチャンクを指定。';
$_lang['articles.setting.commentsUseCss'] = 'Quip用CSS';
...
$_lang['articles.setting.commentsNameField'] = '名前';
...
$_lang['articles.setting.commentsShowAnonymousName'] = '匿名の表示';
$_lang['articles.setting.commentsShowAnonymousName_desc'] = '名前の無いコメントに匿名指定で設定した名前（デフォルトは"Anonymous")を表示します。';
$_lang['articles.setting.commentsAnonymousName'] = '匿名指定';
$_lang['articles.setting.commentsAnonymousName_desc'] = '名前の無いコメントに表示する名前。デフォルトは"Anonymous"です。';
$_lang['articles.setting.commentsLimit'] = 'ページあたりのコメント表示数';
$_lang['articles.setting.commentsLimit_desc'] = '0以外の値を指定すると、1ページに表示するコメントをその数に制限します。';
...
$_lang['articles.setting.commentsAllowReportAsSpam'] = 'コメントスパム報告の許可';
$_lang['articles.setting.commentsAllowReportAsSpam_desc'] = 'ログインしたユーザーは、コメントスパムの報告が可能になります。';
$_lang['articles.setting.commentsDateFormat'] = '投稿日時のフォーマット';
$_lang['articles.setting.commentsDateFormat_desc'] = 'コメント投稿日時を表示するフォーマットです。構文はPHPのstrftime書式で指定してください。';
$_lang['articles.setting.commentsAutoConvertLinks'] = '自動リンク';
...
/* Settings */
$_lang['setting_articles.default_container_template'] = 'デフォルト記事コンテナテンプレート';
$_lang['setting_articles.default_container_template_desc'] = '新規記事コンテナ作成時の、コンテナのデフォルトテンプレートです。';

$_lang['setting_articles.default_article_template'] = 'デフォルト記事テンプレート';
